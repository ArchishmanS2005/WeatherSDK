                    ...
                    <div className="max-w-7xl mx-auto flex items-center justify-between px-6 h-16">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center">
                                <CloudRain className="text-white w-4 h-4" />
                            </div>
                            <span className="text-lg font-semibold hidden md:block">Adiyogi Features</span>
                        </div>

                        <Link href="/dashboard" className="px-4 py-2 rounded-full bg-white text-black text-xs font-bold hover:bg-zinc-200 transition-colors">
                            Launch App
                        </Link>
                    </div>
                </nav>
