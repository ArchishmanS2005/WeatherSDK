...
void main() {
    ...
    float alpha = min(length(color) * finalFade * opacity, 1.0);
    ...
    return <div ref={containerRef} className="w-full h-full relative overflow-hidden [&_canvas]:block" style={{ backgroundColor: '#000000' }} />;
};
